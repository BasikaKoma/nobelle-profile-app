...
url.searchParams.set("client\_id", process.env.SHOPIFY\_API\_KEY);
url.searchParams.set("scope", scopes);
url.searchParams.set("redirect\_uri", redirectUri);
...
const ok = verifyAppProxySignature(req, process.env.SHOPIFY\_API\_SECRET);
